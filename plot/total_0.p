set autoscale
	...
	set terminal postscript	eps color enhanced font "SFRM1200" 22	size 12,3
...
########   Fitting function    ######################################################################################
 ...
 first1(x) = ($0 > 0 ? base : base = abs(x))
	...
	set key font "SFRM1200,22" at graph 0.96,0.94 vertical maxrows 1  samplen 1.0 spacing 1.
	...
	plot 	'../dati/L_10/N_2/U_-5.0/bb_0.007/corrente.dat'			u 1:($2/2)	w l ls 6 t 'current',\
			'../dati/L_10/N_2/U_-5.0/bb_0.007/fidelity_cat_s.dat'	w l ls 4 t 'fidelity',\
